...
- **Setup script:** `bash ~/.claude/plugins/claude-skills-public/skills/spawn-agent-team/scripts/setup-run-dir.sh <task-slug>` returns the absolute run-dir path on stdout. Capture it before spawning.
